...
class ControlsSubState extends MusicBeatSubstate {
	...
	public function new() {
		...
		var resX = Capabilities.screenResolutionX;
		var resY = Capabilities.screenResolutionY;
		FlxG.scaleMode = new flixel.system.scaleModes.StageSizeScaleMode();
		FlxTween.tween(win, {
			x: Std.int((resX / 2) - (1280 / 2)),
			y: Std.int((resY / 2) - (720 / 2)),
			width: 1280,
			height: 720
		}, 0.85, {ease: FlxEase.cubeOut});
